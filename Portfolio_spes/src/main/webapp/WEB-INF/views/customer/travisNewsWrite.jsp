...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<!-- css -->
	<link href="../resources/css/customerService/travisNewsWrite.css" rel="stylesheet" type="text/css">
	...
	<!-- 미니메뉴 테이블 -->
		...
		<table class="minimenu">
			<tr>
				<td colspan="3" width="33%"><a style="color:white;">(관리자페이지) 트라비스 소식 글쓰기</a></td>
			</tr>
		</table>
		<br><br>
	</div> <!-- 미니메뉴 테이블 끝 -->
	...
	<!-- 게시글 테이블 시작 -->
	<div id="boardtable">
	<form action="travisNewsWriteEnd" method="post" enctype="multipart/form-data">
		...
		<c:choose>
			<c:when test="${sessionScope.uid=='admin'}">
				...
				<tr>
				<th>글제목</th>
				<td><input type="text" name="nsubject" size="50%" required></td>
				</tr>
				
				<tr>
				<th>글내용</th>
				<td height="30%">
				<textarea name="ncontent" cols="100%" rows="10%" required></textarea>
				</td>
				</tr>
