              ...
              <form id="form1" method="get">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                      <th width="10%">글번호</th>
                      <td>
                      	<input type="hidden" value="${detail.no}" name="no" readonly >${detail.no}</td>
                    </tr>
                    <tr>
                      <th>글제목</th>
                    ...
                    <tr>
                      <th>글내용</th>
                      <td height="300px">${detail.content}</td>
                    </tr>
                    <tr>
                      <th>작성자</th>
                      <td>${detail.writer}</td>
                    ...
                    <tr>
                      <td colspan="2">
                      <input type="submit" value="돌아가기" id="return" class="btn btn-primary">
